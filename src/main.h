...
public:
    ...
    {
        // MotaCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // MotaCoin: get transaction coin age
...
public:
    ...
    // MotaCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // MotaCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // MotaCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // MotaCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // MotaCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // MotaCoin: block index flags
    enum  
    {
